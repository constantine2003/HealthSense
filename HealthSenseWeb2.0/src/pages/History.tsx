...
const History: React.FC = () => {
  ...
  const getHealthData = (record: CheckupRecord) => {
    ...
    const rawH = Number(record.height), heightM = rawH, displayH = isMetric ? heightM : heightM*39.3701; let heightStatus = l.status.average, heightType: StatusType = "success";
